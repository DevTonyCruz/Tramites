...
Route::group(['prefix' => 'roles', 'middleware' => ['auth', 'permission']], function () {
    ...
    Route::get('/{id}',        'RolesController@edit')->name('roles.edit');
...
Route::group(['prefix' => 'remitente', 'middleware' => ['auth', 'permission']], function () {
...
Route::group(['prefix' => 'gestion', 'middleware' => ['auth', 'permission']], function () {
...
Route::group(['prefix' => 'tramites', 'middleware' => ['auth', 'permission']], function () {
...
Route::group(['prefix' => 'grupos', 'middleware' => ['auth', 'permission']], function () {
...
Route::group(['prefix' => 'profesiones', 'middleware' => ['auth', 'permission']], function () {
...
Route::group(['prefix' => 'fechas', 'middleware' => ['auth', 'permission']], function () {
    ...
    Route::get('/{id}/edit',        'FechasController@edit')->name('fechas.edit');
    ...
    Route::get('/importantes',      'FechasController@importantes')->name('fechas.importantes');
    Route::post('/export',          'FechasController@export')->name('fechas.export');
});

Route::group(['prefix' => 'directorio', 'middleware' => ['auth', 'permission']], function () {
    Route::get('/',             'DirectorioController@index')->name('directorio.index');
    Route::get('/create',       'DirectorioController@create')->name('directorio.create');
    Route::post('/',            'DirectorioController@store')->name('directorio.store');
    Route::get('/edit/{id}',         'DirectorioController@edit')->name('directorio.edit');
    Route::put('/{id}',         'DirectorioController@update')->name('directorio.update');
    Route::delete('/{id}',      'DirectorioController@destroy')->name('directorio.destroy');
