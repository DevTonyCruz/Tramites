            ...
            <div class="d-flex align-items-center">
                ...
                <div>
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ url('/fecha') }}">Fechas</a></li>
    ...
    <div class="row">
        <div class="widget has-shadow col-lg-6 col-md-12">
            ...
            <div class="widget-body">
                <form class="form-horizontal" method="POST" action="{{ url('fechas/' . $fecha->id) }}">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-lg-9">
                            <div class="input-group">
                                ...
                                <input type="text" name="fecha" id="fecha"
                                        ...
                                        value="{!! \Carbon\Carbon::parse($fecha->fecha)->format('m/d/Y') !!}">
                    ...
                    <div class="form-group row d-flex align-items-center mb-5">
                        ...
                        <div class="col-lg-9">
                            <textarea id="descripcion" name="descripcion"
                                    ...
                                    placeholder="Ingrese una descripción">{{ $fecha->descripcion }}</textarea>
