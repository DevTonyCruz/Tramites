    ...
    <div class="row">
        <div class="widget has-shadow col-lg-6 col-md-12">
            ...
            <div class="widget-body">
                <form class="form-horizontal" method="POST" action="{{ url('profesiones/' . $grupo->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group row d-flex align-items-center mb-5">
                        <label for="descripcion" class="col-lg-3 form-control-label">Fecha</label>
                        <div class="col-lg-9">
                            <div class="input-group">
                                ...
                                <input type="text" name="fecha" id="fecha"
                                        ...
                                        value="{!! \Carbon\Carbon::parse($grupo->fecha)->format('m/d/Y') !!}">
                    ...
                    <div class="form-group row d-flex align-items-center mb-5">
                        ...
                        <div class="col-lg-9">
                            <textarea id="descripcion" name="descripcion"
                                    ...
                                    placeholder="Ingrese una descripción">{{ $grupo->descripcion }}</textarea>
