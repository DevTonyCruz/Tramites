...
<div class="container-fluid">
    <div class="row">
        <div class="page-header">
            <div class="d-flex align-items-center">
                <h2 class="page-header-title">Profesiones</h2>
                <div>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)"><i class="ti ti-user"></i></a></li>
                        <li class="breadcrumb-item"><a href="{{ url('/profesiones') }}">Profesiones</a></li>
    ...
    <div class="row flex-row">
        <div class="col-xl-2 col-md-4 col-sm-12">
            <a href="{{ Route('profesiones.create') }}" class="w-100" title="Agregar registro">
                ...
                <table id="datatable" class="table mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $profesion->fechaMes }}</td>
                            <td class="td-actions">
                                <a href="{{ url('profesiones/' . $profesion->id) }}" title="Editar"> <i class="la la-edit edit"></i></a>
                                <a href="javascript:void(0)" onclick="ObjectForms.FormsAddAction('form_delete', '{{ url('profesiones/' . $profesion->id) }}');" title="Eliminar">
