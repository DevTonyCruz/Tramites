                    ...
                    <div class="row flex-row justify-content-center">
                        <div class="col-xl-10">
                            <div class="tab-content">
                                <form class="form-horizontal" id="form-directorio" action="{{ url('directorio/' . $directorio->id) }}" method="POST" accept-charset="UTF-8" enctype="multipart/form-data">
                                    @method('PUT')
                                    @csrf
                                    ...
                                    <div class="form-group row mb-3">
                                        <div class="col-xl-4 mb-3">
                                            ...
                                            value="{{ $directorio->nombre }}" required>
                                        ...
                                        <div class="col-xl-4 mb-3">
                                            ...
                                            <input type="text" id="appaterno" name="appaterno"
                                                    ...
                                                    value="{{ $directorio->appaterno }}" required>
                                        ...
                                        <div class="col-xl-4 mb-3">
                                            ...
                                            <input type="text" id="apmaterno" name="apmaterno"
                                                    ...
                                                    value="{{ $directorio->apmaterno }}" required>
                                        ...
                                        <div class="col-xl-6 mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" id="email" name="email"
                                                        ...
                                                        value="{{ $directorio->email }}" required>
                                                @if ($errors->has('email'))
                                                    <span class="invalid-feedback d-block" role="alert">
                                    ...
                                    <div class="form-group row mb-3">
                                        <div class="col-xl-4 mb-3">
                                            ...
                                            value="{{ $directorio->seccional }}" required>
                                        ...
                                        <div class="col-xl-4 mb-3">
                                            ...
                                            value="{{ $directorio->demarcacion }}" required>
                                        ...
                                        <div class="col-xl-4 mb-3">
                                            ...
                                            value="{{ $directorio->distrito }}" required>
                                        ...
                                        <div class="col-xl-4 mb-3">
                                            ...
                                            <select class="form-control{{ $errors->has('id_profesion') ? ' has-error' : '' }}"
                                                ...
                                                @foreach ($profesiones as $profesion)
                                                    <option value="{{ $profesion->id }}" {{ ($directorio->id_profesion == $profesion->id) ? 'selected' : '' }}>{{ $profesion->nombre }}</option>
                                                @endforeach
                                        ...
                                        <div class="col-xl-4 mb-3">
                                            ...
                                            <select class="form-control{{ $errors->has('id_grupos') ? ' has-error' : '' }}"
                                                    ...
                                                    @foreach ($grupos as $grupo)
                                                        <option value="{{ $grupo->id }}" {{ ($directorio->id_grupos == $grupo->id) ? 'selected' : '' }}>{{ $grupo->nombre . ' ' . $grupo->appaterno . ' ' . $grupo->apmaterno }}</option>
                                                    @endforeach
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="fecha_nacimiento" id="fecha_nacimiento"
                                                            ...
                                                            value="{!! \Carbon\Carbon::parse($directorio->fecha_nacimiento)->format('m/d/Y') !!}">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="fecha_contacto" id="fecha_contacto"
                                                            ...
                                                            value="{!! \Carbon\Carbon::parse($directorio->fecha_contacto)->format('m/d/Y') !!}">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="fecha_importante" id="fecha_importante"
                                                            ...
                                                            value="{!! \Carbon\Carbon::parse($directorio->fecha_importante)->format('m/d/Y') !!}">
                                        ...
                                        <div class="col-xl-3 mb-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                value="{{ $directorio->concepto_fecha_importante }}" required>
                                        ...
                                        <div class="col-xl-12 mb-3">
                                            ...
                                            required>{{ $directorio->observaciones }}</textarea>
                                    ...
                                    <div class="form-group row mb-3">
                                        <div class="col-xl-4 mb-3">
                                            ...
                                            value="{{ $directorio->coordinador_zona }}" required>
                                        ...
                                        <div class="col-xl-4 mb-3">
                                            ...
                                            value="{{ $directorio->coordinador_demarcacion }}" required>
                                        ...
                                        <div class="col-xl-4 mb-3">
                                            ...
                                            value="{{ $directorio->distrito_politico }}" required>
                                    ...
                                    <div id="politico">
                                        <div class="form-group row mb-3">
                                            <div class="col-xl-4 mb-3">
                                                ...
                                                value="{{ $directorio->demarcacion_politico }}" required>
                                            ...
                                            <div class="col-xl-4 mb-3">
                                                ...
                                                value="{{ $directorio->seccional_politico }}" required>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $("#directorio #zip_code").val('{{ $directorio->sepomex->zip_code }}');
        SepomexObject.searchZipSelectedEditing('directorio', '{{ $directorio->sepomex->zip_code }}', {{ $directorio->sepomex_id }});
    ...
    $(document).ready(function(){
        $("#politico #zip_code").val('{{ $directorio->sepomex_politico->zip_code }}');
        SepomexObject.searchZipSelectedEditing('politico', '{{ $directorio->sepomex_politico->zip_code }}', {{ $directorio->sepomex_id_politico }});
