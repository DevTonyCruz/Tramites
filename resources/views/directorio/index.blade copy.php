...
<div class="container-fluid">
    ...
    <div class="row flex-row">
        <div class="col-xl-2 col-md-4 col-sm-12">
            <a href="{{ Route('directorio.create') }}" class="w-100" title="Agregar registro">
        ...
        <div class="col-xl-2 col-md-4 col-sm-12" title="Registros en tramite: ">
            <div class="widget widget-12 bg-gradient-success has-shadow">
                <div class="widget-body">
                    <div class="media d-block">
                        ...
                        <div class="media-body align-self-center text-center">
                            <div class="title text-white">Registros en tramite: </div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xl-2 col-md-4 col-sm-12" title="Registros cerrados:  ">
            <div class="widget widget-12 bg-gradient-dark has-shadow">
                <div class="widget-body">
                    <div class="media d-block">
                        ...
                        <div class="media-body align-self-center text-center">
                            <div class="title text-white">Registros cerrados: </div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xl-2 col-md-4 col-sm-12" title="Registros por vence: ">
            <div class="widget widget-12 bg-gradient-warning has-shadow">
                <div class="widget-body">
                    <div class="media d-block">
                        ...
                        <div class="media-body align-self-center text-center">
                            <div class="title text-white">Registros por vencer:  </div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xl-2 col-md-4 col-sm-12" title="Registros vencidos: ">
            <div class="widget widget-12 bg-gradient-danger has-shadow">
                <div class="widget-body">
                    <div class="media d-block">
                        ...
                        <div class="media-body align-self-center text-center">
                            <div class="title text-white">Registros vencidos: </div>
                        </div>
                    </div>
                </div>
            </div>
