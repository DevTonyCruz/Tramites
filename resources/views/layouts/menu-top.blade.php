            ...
            <div class="navbar-header">
                <a href="{{ route('home') }}" class="navbar-brand">
                    <div class="brand-image brand-big" style="display: none;">
                        <img src="{{ (is_null($logo_system)) ? 'assets/img/logo.png' : asset($logo_system) }}" alt="logo" class="logo-big">
                    </div>
                    <div class="brand-image brand-small" style="display: block;">
                        <img src="{{ (is_null($logo_system)) ? 'assets/img/logo.png' : asset($logo_system) }}" alt="logo" class="logo-small">
                    </div>
                </a>
                <!-- Toggle Button -->
            ...
            <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center pull-right">
                ...
                <li class="nav-item dropdown">
                    <a id="user" rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link">
                        <img src="{{ (is_null($logo_system)) ? 'assets/img/avatar/avatar-01.jpg' : asset($logo_system) }}" alt="..." class="avatar rounded-circle"></a>
                    <ul aria-labelledby="user" class="user-size dropdown-menu">
                        <li class="welcome">
                            <img src="{{ (is_null($logo_system)) ? 'assets/img/avatar/avatar-01.jpg' : asset($logo_system) }}" alt="..." class="rounded-circle">
                        </li>
                        <li>
