...
<div class="container-fluid">
            ...
            <div class="d-flex align-items-center">
                ...
                <div>
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ url('/grupos') }}">Grupos</a></li>
    ...
    <div class="row flex-row">
        <div class="col-xl-2 col-md-4 col-sm-12">
            <a href="{{ Route('grupos.create') }}" class="w-100" title="Agregar registro">
    ...
    <div class="widget has-shadow">
        ...
        <div class="widget-body">
            <div class="table-responsive">
                <table id="grupos-list" class="table mb-0">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Nombre</th>
...
<script type="text/javascript">
    let URLList     = "{{ url('api/list/grupos') }}";
    let URLStatus   = "{{ url('grupos/status/') }}";
    let URLAction   = "{{ url('grupos/') }}";
    let URLNew      = "{{ url('grupos/create') }}";
</script>

<script src="{{ asset('assets/js/general/forms.js') }}"></script>
<script src="{{ asset('assets/js/sections/grupos/table.js') }}"></script>
@endsection
