        ...
        <div class="col-xl-12">
            ...
            <div class="widget has-shadow">
                <div class="widget-header bordered no-actions d-flex align-items-center">
                    <h4>Editar tramite</h4>
                </div>
                <div class="widget-body">
                    <div class="row flex-row justify-content-center">
                        <div class="col-xl-10">
                            <div class="tab-content" id="tramites">
                                <form class="form-horizontal" id="form-tramites" action="{{ url('tramites/' . $tramite->id) }}" method="POST" accept-charset="UTF-8" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="form-group row mb-3">
                                        ...
                                        <div class="col-xl-4">
                                            ...
                                            <input type="text" id="appaterno" name="appaterno"
                                                    ...
                                                    value="{{ $tramite->appaterno }}" required>
                                        ...
                                        <div class="col-xl-4">
                                            ...
                                            <input type="text" id="apmaterno" name="apmaterno"
                                                    ...
                                                    value="{{ $tramite->apmaterno }}" required>
                                    ...
                                    <div class="form-group row mb-3">
                                        ...
                                        <div class="col-xl-2 mb-3">
                                            ...
                                            <input type="text" id="zip_code" name="zip_code"
                                                    ...
                                                    value="{{ (is_null($tramite->sepomex_id)) ? '' : $tramite->sepomex->zip_code }}"
                                    ...
                                    <div class="form-group row mb-3">
                                        <div class="col-xl-4 mb-3">
                                            ...
                                            value="{{ $tramite->seccional }}" required>
                                        ...
                                        <div class="col-xl-4 mb-3">
                                            ...
                                            value="{{ $tramite->demarcacion }}" required>
                                        ...
                                        <div class="col-xl-4 mb-3">
                                            ...
                                            value="{{ $tramite->distrito }}" required>
                                        ...
                                        <div class="col-xl-4 mb-3">
                                            ...
                                            value="{{ $tramite->simpatizante }}" required>
                                        ...
                                        <div class="col-xl-4 mb-3">
                                            ...
                                            <select class="form-control{{ $errors->has('gestion') ? ' has-error' : '' }}"
                                                ...
                                                @foreach ($gestiones as $gestion)
                                                    <option value="{{ $gestion->id }}" {{ ($tramite->gestion_id == $gestion->id) ? 'selected' : '' }}>{{ $gestion->nombre }}</option>
                                                @endforeach
                                        ...
                                        <div class="col-xl-4 mb-3">
                                            ...
                                            <select class="form-control{{ $errors->has('remitente') ? ' has-error' : '' }}"
                                                    ...
                                                    @foreach ($remitentes as $remitente)
                                                        <option value="{{ $remitente->id }}" {{ ($tramite->remitente_id == $remitente->id) ? 'selected' : '' }}>{{ $remitente->nombre . ' ' . $remitente->appaterno . ' ' . $remitente->apmaterno }}</option>
                                                    @endforeach
                                        ...
                                        <div class="col-xl-4">
                                            <label class="col-lg-12 form-control-label">Fecha inicial</label>
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="fecha_ini" id="fecha_ini"
                                                            ...
                                                            value="{!! \Carbon\Carbon::parse($tramite->fecha_ini)->format('m/d/Y') !!}">
                                        ...
                                        <div class="col-xl-4">
                                            <label class="col-lg-12 form-control-label">Fecha final</label>
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <span class="input-group-addon addon-secondary">
                                                        <i class="la la-calendar"></i>
                                                    ...
                                                    <input type="text" name="fecha_fin" id="fecha_fin"
                                                            class="form-control datepicker{{ $errors->has('fecha_ini') ? ' has-error' : '' }}"
                                                            value="{!! \Carbon\Carbon::parse($tramite->fecha_fin)->format('m/d/Y') !!}">
                                        ...
                                        <div class="col-xl-2 pt-5">
                                            <div class="styled-checkbox">
                                                ...
                                                <label for="status">Cerrar tramite</label>
                                            </div>
                                        </div>
                                        <div class="col-xl-4 mb-3">
                                        ...
                                        <div class="col-xl-2 mb-3">
                                            @if($tramite->foto)
                                            <img src="{{ asset($tramite->foto) }}" class="img-thumbnail" alt="Responsive image">
                                            @endif
                                        </div>
                                        <div class="col-xl-6 mb-3">
