...
class DirectorioGruposExport implements FromQuery, WithMapping, WithHeadings, WithEvents, WithColumnFormatting
{
    protected $grupo_id;
    ...
    */
    ...
    {
        if($this->grupo_id <= 0){
            $grupos = Directorio::query();
        }else{
            $grupos = Directorio::where('id_grupos', $this->grupo_id);
        }
        return $grupos;
    }
